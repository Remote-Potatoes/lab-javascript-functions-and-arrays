...
function findLongestWord(array) {
  ...
  //   if (array[i].length > longesWord.length) {
  //     longesWord = array[i];
  //   }
  // }
  ...
  for (const variableName of array) {
    if (variableName.length > longestWord.length) {
...
const wordsUnique = [
  'crab', // 0 -> uniqueArray -1 - ['crab']
  'poison', // 1 -> uniqueArray -1 ['crab', 'poison']
  'contagious', // ['crab', 'poison', 'contagious']
  'simple',
  'bring',
  'sharp',
  'playground',
  'poison', // 7 -> uniqueArray 1 ['crab', 'poison', ']
  'communion',
  'simple',
  'bring'
];
